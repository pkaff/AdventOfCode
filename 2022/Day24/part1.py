...
def get_next_possible_moves(cur_pos, up_tornados, down_tornados, left_tornados, right_tornados, time):
    ...
    return [next_pos for next_pos in potential_moves if next_pos == stop or (not is_boundary(next_pos) and is_in_bounds(next_pos) and not tornados_blocking(next_pos, up_tornados, down_tornados, left_tornados, right_tornados, time))]
...
while frontier:
    ...
    next_moves = get_next_possible_moves(pos, up_tornados, down_tornados, left_tornados, right_tornados, time + 1)
